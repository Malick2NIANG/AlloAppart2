...
export default async function ListingsPage({
  ...
  searchParams: Promise<{ page?: string; city?: string; type?: string; q?: string; minPrice?: string; maxPrice?: string; region?: string; limit?: string }>;
}) {
  const { page = '1', city, type, q, minPrice, maxPrice, region, limit: limitParam } = await searchParams;
