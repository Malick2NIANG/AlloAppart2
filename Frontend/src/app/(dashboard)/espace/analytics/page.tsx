  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-sub">{t('analyticsSubtitle')}</p>
      </div>

      {/* KPIs globaux */}
      <div>
        <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-sub">{t('kpiGlobal')}</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <Stat icon="fa-solid fa-calendar-check" label={t('kpiBookingsTotal')}     value={String(stats.totalBookings)} />
          <Stat icon="fa-solid fa-handshake"      label={t('kpiBookingsConfirmed')} value={String(stats.confirmedBookings)} />
          <Stat icon="fa-solid fa-sack-dollar"    label={t('kpiRevenue')}           value={formatPrice(stats.totalRevenue)} />
          <Stat icon="fa-solid fa-hourglass-half" label={t('kpiVerifsPendingLong')} value={String(stats.pendingVerifications)} />
          <Stat icon="fa-solid fa-shield-halved"  label={t('kpiVerifsDoneLong')}    value={String(stats.completedVerifications)} />
        </div>
      </div>

      {/* 30 derniers jours */}
      <div>
        <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-sub">{t('last30Days')}</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
